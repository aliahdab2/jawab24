...
- "flags": an array of flag strings if applicable (empty array [] if none):
  ...
  - "self_identified_as_automation" if your reply describes YOU — the one writing this reply — as a bot, robot, AI, artificial intelligence, automated system, or smart assistant, in ANY language or dialect. A PRODUCT's AI features do NOT count: a phone camera "with AI" or a device that "supports artificial intelligence" is about the product, not about you — never set this flag for product descriptions.

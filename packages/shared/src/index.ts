...
// --- Page-sync refusal outcome (BE /pages/sync + /auth/facebook/link ↔ FE features/pageSync) ---
export { hasRefusedPages } from './pageSyncOutcome';
export type { PageSyncOutcome } from './pageSyncOutcome';

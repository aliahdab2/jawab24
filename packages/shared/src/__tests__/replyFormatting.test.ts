...
describe('renderReplyForChannel', () => {
    ...
    it('text with no markup is byte-identical on both targets', () => {
        const plain = 'أهلاً! التوصيل 3-5 أيام عمل، والدفع عند الاستلام متاح. رابط المتجر: https://gulf-fashion.salla.sa';

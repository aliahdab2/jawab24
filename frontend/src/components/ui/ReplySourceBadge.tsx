...
import { MessageSquare, Sparkles, UserCheck, KeyRound } from 'lucide-react';
...
export const ReplySourceBadge = React.memo(function ReplySourceBadge({
  ...
  const config = {
    ...
    post_reply: { Icon: KeyRound, label: tDashboard('postReply'), colorClass: 'reply-source-template' },

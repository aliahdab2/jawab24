...
export function MessageDetailModal({
  ...
  return (
    <div className="fixed inset-0 bg-surface-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] landscape:max-h-[95vh] overflow-hidden flex flex-col animate-scale-in">
        {/* Header */}
            ...
            <div className="flex items-center gap-2">
              ...
              {hasUnresolvedUnreplied && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-all border bg-surface-50 text-surface-600 border-surface-200 hover:bg-surface-100"
                >

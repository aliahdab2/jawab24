      ...
      <div key={msg.id} className="flex items-end justify-end gap-2 sm:gap-3 ms-6 sm:ms-12">
        <div className="flex flex-col items-end gap-1 min-w-0">
          <div className="relative">
            <div className="px-3 sm:px-4 py-2.5 sm:py-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl rounded-tr-sm text-foreground dark:text-emerald-200 text-sm leading-relaxed border border-emerald-100 dark:border-emerald-800 shadow-sm">
    ...
    >
      ...
      {conv.pauseStatus?.paused ? (
        <div className="absolute top-3 end-3 sm:top-4 sm:end-4 z-10 animate-fade-in">
          <div className="flex items-center gap-1 sm:gap-1.5 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full bg-violet-50 text-violet-600 dark:bg-violet-900/30 dark:text-violet-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider border border-violet-100 dark:border-violet-800">
        ...
        <div className="absolute top-3 end-3 sm:top-4 sm:end-4 z-10 animate-fade-in">
          <div className="flex items-center gap-1 sm:gap-1.5 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider animate-pulse-soft border border-red-100 dark:border-red-800">
        ...
        isPending && (
          <div className="absolute top-3 end-3 sm:top-4 sm:end-4 z-10 animate-fade-in">
            <div className="flex items-center gap-1 sm:gap-1.5 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider border border-amber-100 dark:border-amber-800">
      ...
      <div className="p-3.5 sm:p-5 flex flex-col gap-3 sm:gap-4">
        ...
        <div className="flex items-center justify-between mt-1">
          ...
          {conv.needsHumanAttention ? (
            <div className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400 border border-red-100 dark:border-red-800 text-[10px] sm:text-xs font-bold uppercase tracking-wider group-hover:bg-red-100 dark:group-hover:bg-red-900/50 transition-colors animate-fade-in">

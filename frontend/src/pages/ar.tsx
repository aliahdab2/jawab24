...
// صفحة عربية مخصصة 100% لتحسين SEO العربي
export default function ArabicLandingPage() {
  ...
  const features = [
    {
      ...
      description: 'ردود مخصصة وذكية تفهم سياق المحادثة وتوفر إجابات دقيقة لعملائك',
    },
    {
      icon: Instagram,
      title: 'دعم فيسبوك وإنستغرام',
      description: 'ردود تلقائية على التعليقات والرسائل في كلا المنصتين من مكان واحد',
    },
    {
      icon: Languages,
      title: 'دعم العربية والإنجليزية',
      description: 'ردود تلقائية بلغة العميل - سواء كان يكتب بالعربية أو الإنجليزية',
    },
    {
      icon: Zap,
      title: 'رد فوري 24/7',
      description: 'لا تجعل عملائك ينتظرون أبداً، نرد في أقل من ثانية حتى وأنت نائم',
    },
    {
      icon: BookOpen,
      title: 'قاعدة معرفة مخصصة',
      description: 'أضف معلومات عملك ومنتجاتك وأسعارك لتدريب الذكاء الاصطناعي الخاص بك',
    },
    {
      icon: Smartphone,
      title: 'متوافق مع الجوال',
      description: 'أدِر عملك من أي مكان من خلال واجهة سهلة الاستخدام على جميع الأجهزة',
    },
  ];
  ...
  const howItWorks = [
    {
      step: '1',
      title: 'اربط صفحتك',
      description: 'سجل دخولك بفيسبوك واختر الصفحات التي تريد تفعيل الردود عليها',
    },
    {
      step: '2',
      title: 'أضف معلوماتك',
      description: 'اكتب نبذة عن منتجاتك وأسعارك ليعرف الذكاء الاصطناعي كيف يجيب',
    },
    {
      step: '3',
      title: 'ارتح وراقب',
      description: 'اترك الردود لنا وتابع التفاعلات والنتائج من لوحة التحكم',
    },
  ];

  const faqs = [
    {
      question: 'هل جواب24 يدعم إنستغرام؟',
      answer: 'نعم، جواب24 يدعم كلاً من صفحات فيسبوك وحسابات إنستغرام التجارية المرتبطة بها في جميع الباقات.',
    },
    {
      question: 'كم تكلفة الخدمة؟',
      answer: 'نوفر تجربة مجانية لمدة 30 يوم، ثم تبدأ الباقات من $5 شهرياً. باقة الأعمال بـ$19 تناسب معظم المستخدمين مع 9,000 رد ذكي شهرياً.',
    },
    {
      question: 'كيف يضمن النظام دقة الردود؟',
      answer: 'من خلال "قاعدة المعرفة" التي تضيفها، يلتزم الذكاء الاصطناعي بالمعلومات التي توفرها فقط لضمان عدم تقديم إجابات خاطئة.',
    },
    {
      question: 'هل يمكنني الترقية أو تغيير الباقة لاحقاً؟',
      answer: 'بالتأكيد! يمكنك الترقية أو تغيير باقتك في أي وقت من لوحة التحكم. التغيير يطبق فوراً.',
    },
  ];
  ...
  return (
    <>
      <Head>
        {/* Arabic-specific SEO */}
        <title>جواب | جواب24 - الرد التلقائي الذكي على فيسبوك وإنستغرام</title>
        <meta name="description" content="جواب24 - أفضل خدمة رد تلقائي ذكي على تعليقات ورسائل فيسبوك وإنستغرام. ردود فورية بالذكاء الاصطناعي على مدار الساعة. جرب مجاناً لمدة 30 يوم!" />
        <meta name="keywords" content="جواب, جواب24, جواب 24, جواب٢٤, رد تلقائي, ردود تلقائية, رد تلقائي فيسبوك, رد تلقائي انستغرام, بوت فيسبوك, بوت انستغرام عربي, ردود ذكية, رد آلي, الرد الذكي, jawab, jawab24" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        
        {/* Arabic-specific Open Graph */}
        <meta property="og:title" content="جواب | جواب24 - الرد التلقائي الذكي لفيسبوك وإنستغرام" />
        <meta property="og:description" content="جواب24 - خدمة الرد التلقائي الذكي على تعليقات ورسائل فيسبوك وإنستغرام 24/7. ردود فورية ذكية بالعربية." />
        <meta property="og:locale" content="ar_SA" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://jawab24.com/ar" />
        <meta property="og:image" content="https://jawab24.com/og-image.png" />
        
        {/* Hreflang */}
        <link rel="alternate" hrefLang="ar" href="https://jawab24.com/ar" />
        <link rel="alternate" hrefLang="en" href="https://jawab24.com/landing" />
        <link rel="alternate" hrefLang="x-default" href="https://jawab24.com/" />
        <link rel="canonical" href="https://jawab24.com/ar" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "جواب24",
              "alternateName": ["Jawab24", "Jawab", "جواب", "جواب ٢٤"],
              "applicationCategory": "BusinessApplication",
              "operatingSystem": "Web",
              "description": "جواب24 - خدمة الرد التلقائي الذكي على تعليقات ورسائل فيسبوك وإنستغرام بالذكاء الاصطناعي",
              "url": "https://jawab24.com/ar",
              "inLanguage": "ar",
              "offers": {
                "@type": "Offer",
                "price": "0",
      ...
      <div className="min-h-screen bg-white" dir="rtl">
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-surface-100">
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14 sm:h-20">
              {/* Logo */}
              <Link href="/ar" className="flex items-center gap-2 sm:gap-3 group">
                ...
                <span className="font-display font-bold text-lg sm:text-2xl text-surface-900 tracking-tight">جواب24</span>
              </Link>
              ...
              <div className="flex items-center gap-1 sm:gap-4">
                ...
                <Link href="/landing" className="px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-surface-600 hover:text-brand-600 rounded-lg sm:rounded-xl hover:bg-brand-50 transition-all">
                  English
                </Link>
                <Link href="/login">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-display font-extrabold text-surface-900 mb-4 sm:mb-8 leading-snug sm:leading-[1.15] tracking-tight animate-slide-up">
                حوّل صفحتك إلى
                <span className="block bg-gradient-to-r from-brand-600 to-violet-600 bg-clip-text text-transparent pb-1 sm:pb-2 mt-2">
                  آلة رد ذكية 24/7
                </span>
              </h1>

              {/* Description */}
              <p className="text-base sm:text-lg lg:text-xl text-surface-600 mb-6 sm:mb-12 max-w-2xl mx-auto leading-relaxed animate-slide-up animation-delay-100">
                أول نظام عربي متخصص في الرد الذكي على تعليقات ورسائل فيسبوك وإنستغرام. وفّر وقتك وزد مبيعاتك بردود فورية دقيقة.
              </p>

              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-6 sm:mb-12 animate-slide-up animation-delay-200">
              ...
              {/* Platform Icons */}
              <div className="flex items-center justify-center gap-4 sm:gap-8 text-surface-400 opacity-60 grayscale hover:grayscale-0 transition-all animate-slide-up animation-delay-300">
        ...
        {/* Features Section */}
        <section className="py-12 sm:py-20 lg:py-32 bg-surface-50 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-16 lg:mb-24">
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-display font-extrabold text-surface-900 mb-3 sm:mb-6 tracking-tight">
                كل ما تحتاجه للسيطرة على صفحاتك
              </h2>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-20">
              <div className="lg:w-1/2">
                <h2 className="text-2xl sm:text-4xl lg:text-5xl font-display font-extrabold text-surface-900 mb-4 sm:mb-8 leading-normal sm:leading-tight text-center lg:text-start">
                  ابدأ في أقل من
                  <span className="block text-brand-600 mt-1 sm:mt-0">دقيقتين فقط</span>
                </h2>
              ...
              <div className="lg:w-1/2 relative hidden lg:block">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-8 border-surface-900/5 rotate-2 group hover:rotate-0 transition-transform duration-700">
                  <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?auto=format&fit=crop&q=80&w=1000" alt="لوحة التحكم" className="w-full" />
        ...
        <section className="py-10 sm:py-16 lg:py-24 bg-brand-600 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <h2 className="text-lg sm:text-2xl lg:text-4xl font-display font-bold text-white mb-4 sm:mb-8 leading-relaxed italic px-2">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-white font-bold text-base sm:text-xl">أحمد سليمان</div>
              <div className="text-brand-200 font-medium uppercase tracking-widest text-[10px] sm:text-xs mt-1">صاحب متجر إلكتروني</div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-8 mb-8 sm:mb-16 max-w-4xl mx-auto">
              ...
              <div className="text-center p-2 sm:p-6 rounded-xl sm:rounded-2xl hover:bg-surface-50 transition-colors">
                ...
                <h3 className="text-sm sm:text-lg font-bold text-surface-900 mb-1 sm:mb-2">المبتدئ</h3>
                <p className="text-[10px] sm:text-sm text-surface-500 mb-2 sm:mb-3 hidden sm:block">للمشاريع الصغيرة</p>
                <ul className="text-[10px] sm:text-sm text-surface-600 space-y-0.5 sm:space-y-1">
                  <li>✓ صفحة واحدة</li>
                  <li className="hidden sm:block">✓ ردود ذكية</li>
                  <li>✓ 30 يوم مجاناً</li>
                </ul>
              </div>
              ...
              <div className="text-center p-2 sm:p-6 rounded-xl sm:rounded-2xl bg-brand-50 border sm:border-2 border-brand-200 relative">
                ...
                <h3 className="text-sm sm:text-lg font-bold text-surface-900 mb-1 sm:mb-2">الأعمال</h3>
                <p className="text-[10px] sm:text-sm text-surface-500 mb-2 sm:mb-3 hidden sm:block">للمتاجر النشطة</p>
                <ul className="text-[10px] sm:text-sm text-surface-600 space-y-0.5 sm:space-y-1">
                  <li>✓ عدة صفحات</li>
                  <li className="hidden sm:block">✓ ردود أكثر</li>
                  <li>✓ بدون علامة</li>
                </ul>
              </div>
              ...
              <div className="text-center p-2 sm:p-6 rounded-xl sm:rounded-2xl hover:bg-surface-50 transition-colors">
                ...
                <h3 className="text-sm sm:text-lg font-bold text-surface-900 mb-1 sm:mb-2">الاحترافي</h3>
                <p className="text-[10px] sm:text-sm text-surface-500 mb-2 sm:mb-3 hidden sm:block">للوكالات الكبيرة</p>
                <ul className="text-[10px] sm:text-sm text-surface-600 space-y-0.5 sm:space-y-1">
                  <li>✓ صفحات أكثر</li>
                  <li className="hidden sm:block">✓ غير محدود</li>
                  <li>✓ دعم أولوية</li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  >
                    <span className={`font-bold text-sm sm:text-lg transition-colors text-start ${openFaq === i ? 'text-brand-600' : 'text-surface-900 group-hover:text-brand-600'}`}>
                      {faq.question}
                    </span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-16 mb-10 sm:mb-20">
              <div className="col-span-2">
                <Link href="/ar" className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-8 group">
                  ...
                  <span className="font-display font-bold text-2xl sm:text-3xl tracking-tight">جواب24</span>
                </Link>
              ...
              <div>
                <h4 className="font-bold text-white text-sm sm:text-lg mb-4 sm:mb-8 uppercase tracking-widest">روابط هامة</h4>
                <ul className="space-y-2 sm:space-y-4 font-medium text-sm sm:text-base">
                  <li><Link href="/pricing" className="text-surface-400 hover:text-brand-400 transition-colors">الباقات والأسعار</Link></li>
                  <li><Link href="/login" className="text-surface-400 hover:text-brand-400 transition-colors">ابدأ تجربتك المجانية</Link></li>
                  <li><Link href="/terms" className="text-surface-400 hover:text-brand-400 transition-colors">شروط الخدمة</Link></li>
                  <li><Link href="/privacy" className="text-surface-400 hover:text-brand-400 transition-colors">سياسة الخصوصية</Link></li>
                </ul>
              </div>

              <div>
                <h4 className="font-bold text-white text-sm sm:text-lg mb-4 sm:mb-8 uppercase tracking-widest">تواصل معنا</h4>
                <ul className="space-y-2 sm:space-y-4 font-medium text-sm sm:text-base">
                  ...
                  <li className="text-surface-400 flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="text-xs sm:text-base">رد خلال 24 ساعة</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="pt-6 sm:pt-12 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
              <div className="text-surface-500 font-bold text-xs sm:text-sm tracking-widest uppercase text-center sm:text-start">
                © {new Date().getFullYear()} جواب24. جميع الحقوق محفوظة.
              </div>

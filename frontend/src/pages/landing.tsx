  ...
  return (
    <div className="min-h-screen bg-white" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="min-h-screen bg-white overflow-x-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <footer className="bg-surface-900 text-white pt-10 sm:pt-16 lg:pt-24 pb-8 sm:pb-12 pb-safe relative overflow-hidden">
        ...
        {/* Fixed bottom safe area background for Android - matches DashboardLayout */}
        <div 
          className="fixed bottom-0 left-0 right-0 bg-surface-900 z-40 pointer-events-none"

...
export default function CompleteProfilePage() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 flex items-center justify-center px-4 pt-safe pb-safe landscape:px-6">
  ...
  if (success) {
    return (
      <div 
        className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 flex items-center justify-center px-4 pt-safe pb-safe landscape:px-6" 
        dir={isRTL ? 'rtl' : 'ltr'}
        role="main"
  ...
  return (
    <>
      ...
      <div 
        className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 flex items-center justify-center px-4 py-8 pt-safe pb-safe landscape:px-6" 
        dir={isRTL ? 'rtl' : 'ltr'}
        role="main"
      >

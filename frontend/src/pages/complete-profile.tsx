...
export default function CompleteProfilePage() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 flex items-center justify-center px-4 pt-safe pb-safe landscape:px-12">
  ...
  if (success) {
    return (
      <div 
        className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 flex items-center justify-center px-4 pt-safe pb-safe landscape:px-12" 
        dir={isRTL ? 'rtl' : 'ltr'}
        role="main"
  ...
  return (
    <>
      ...
      <div 
        className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 flex items-center justify-center px-4 py-8 pt-safe pb-safe landscape:px-12" 
        dir={isRTL ? 'rtl' : 'ltr'}
        role="main"
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            {error && !showEmailError && (
              <div 
                ...
                role="alert"
              >
                <p className={`text-sm text-red-800 flex items-center gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>

...
export default function CheckoutPage() {
  ...
  if (isSanctioned) {
    return (
      <>
        ...
        <div className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 py-6 md:py-10 px-4 relative pt-safe pb-safe landscape:px-6">
  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-violet-50 py-8 md:py-12 px-4 relative pt-safe pb-safe landscape:px-6">

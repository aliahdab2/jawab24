        ...
        <div className="max-w-3xl mx-auto bg-card rounded-2xl shadow-sm p-8 border border-theme-border">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal ps-6 text-muted-foreground space-y-2">
                <li>
                  {t('option1Step1')}{' '}
                ...
                <li>{t('option1Step2')} <strong className="text-foreground">{tNav('settings')}</strong></li>
                <li>{t('option1Step3')} <strong className="text-foreground">{tSettings('deleteAccount')}</strong></li>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal ps-6 text-muted-foreground space-y-2">
                ...
                <li>{t('option2Step2')} <strong className="text-foreground">Jawab24</strong> {t('option2Step2Suffix')}</li>
                <li>{t('option2Step3')} <strong className="text-foreground">{tc('delete')}</strong></li>

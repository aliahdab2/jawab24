...
export default function PaymentSuccessPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center px-4 pt-safe pb-safe" dir={isRTL ? 'rtl' : 'ltr'}>

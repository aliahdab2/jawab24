...
export default function PaymentCancelPage() {
  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center px-4 pt-safe pb-safe landscape:px-6" dir={isRTL ? 'rtl' : 'ltr'}>

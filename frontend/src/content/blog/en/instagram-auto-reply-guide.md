...
1. A brief public reply: "Thanks for your interest! Check your DMs for full details" — this shows other followers you're responsive
2. A detailed DM: The product name, price, available sizes/colors, and how to order
...
1. **Ensure your Instagram account is a Business or Creator account** connected to a Facebook page. Go to Instagram Settings, then Account, then Switch to Professional Account.

2. **Connect your Instagram through the Meta Business Suite.** Most auto-reply tools (including Jawab24) connect via Facebook's API, which grants access to both Facebook and Instagram.

3. **Configure what gets replied to:**

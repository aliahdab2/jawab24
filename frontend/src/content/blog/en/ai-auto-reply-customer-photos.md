...
There's no new switch to flip. Photo understanding is on by default wherever your auto-reply is already active — exactly like voice-note transcription. If the bot is answering your DMs, it's already reading the photos in them. It answers from the same [Business Info](/en/blog/jawab24-setup-tutorial) you've already written, so the more complete that is, the better the answers.

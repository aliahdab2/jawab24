...
// This file's cards need the away-message textarea enabled (businessHoursOnly).
const makeSettings = (overrides: Partial<SettingsState> = {}): SettingsState =>
  makeSharedSettings({ businessHoursOnly: true, timezone: 'Asia/Damascus', replyDelay: 3, ...overrides });

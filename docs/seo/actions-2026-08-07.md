...
*Follow-up to `actions-2026-07-10.md` (July 10) and `audit-jawab24.md` (May 30).*
...
`actions-2026-07-10.md` §1 — **the `www.` variants matter**.
...
1. **AI-crawler reach, from production nginx access logs.** Weekly hit counts for `GPTBot`,
   ...
   > `actions-2026-08-22.md` §1 for the ~40 hours that did survive, and §C there for

...
CREATE UNIQUE INDEX "idx_partners_email_lower" ON "partners" USING btree (lower("email")) WHERE "partners"."email" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "idx_partners_phone" ON "partners" USING btree ("phone") WHERE "partners"."phone" IS NOT NULL;--> statement-breakpoint

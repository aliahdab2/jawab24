...
CREATE TABLE IF NOT EXISTS "settings" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid,
	"dashboard_language" varchar(10) DEFAULT 'en'::character varying,
	"default_reply_language" varchar(10) DEFAULT 'ar'::character varying,
	"supported_languages" text[] DEFAULT ARRAY['en'::text, 'ar'::text],
	"auto_detect_language" boolean DEFAULT true,
	"ai_enabled" boolean DEFAULT true,
	"ai_model" varchar(100) DEFAULT 'gpt-4-mini'::character varying,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS "instagram_comments" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "instagram_comments_instagram_comment_id_key" UNIQUE("instagram_comment_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "messages" (
	...
	"platform" varchar(20) DEFAULT 'facebook'::character varying,
	"sender_id" varchar(255) NOT NULL,
	"sender_name" varchar(255),
	"message" text NOT NULL,
	"direction" varchar(10) DEFAULT 'incoming'::character varying,
	"replied" boolean DEFAULT false,
	"reply_text" text,
	"reply_method" varchar(50),
	"created_time" timestamp,
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "messages_facebook_message_id_key" UNIQUE("facebook_message_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "plans" (
	...
	"interval" varchar(20) DEFAULT 'month'::character varying,
...
CREATE INDEX IF NOT EXISTS "idx_templates_translations" ON "templates" ("translations");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_rules_user_id" ON "rules" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_rules_priority" ON "rules" ("priority");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_subscriptions_stripe_customer" ON "subscriptions" ("stripe_customer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_subscriptions_external_subscription" ON "subscriptions" ("external_subscription_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_plans_stripe_price" ON "plans" ("stripe_price_id");--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "rules" ADD CONSTRAINT "rules_template_id_templates_id_fk" FOREIGN KEY ("template_id") REFERENCES "public"."templates"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "logs" ADD CONSTRAINT "logs_page_id_pages_id_fk" FOREIGN KEY ("page_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "logs" ADD CONSTRAINT "logs_comment_id_comments_id_fk" FOREIGN KEY ("comment_id") REFERENCES "public"."comments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "posts" ADD CONSTRAINT "posts_page_id_pages_id_fk" FOREIGN KEY ("page_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "comments" ADD CONSTRAINT "comments_template_id_templates_id_fk" FOREIGN KEY ("template_id") REFERENCES "public"."templates"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "instagram_media" ADD CONSTRAINT "instagram_media_page_id_fkey" FOREIGN KEY ("page_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "instagram_comments" ADD CONSTRAINT "instagram_comments_media_id_fkey" FOREIGN KEY ("media_id") REFERENCES "public"."instagram_media"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "messages" ADD CONSTRAINT "messages_page_id_fkey" FOREIGN KEY ("page_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "usage" ADD CONSTRAINT "usage_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "usage_logs" ADD CONSTRAINT "usage_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "usage_logs" ADD CONSTRAINT "usage_logs_page_id_fkey" FOREIGN KEY ("page_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_plan_id_fkey" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;

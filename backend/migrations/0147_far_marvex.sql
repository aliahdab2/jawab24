...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_subscriptions_shopify_shop_domain" ON "subscriptions" ("shopify_shop_domain") WHERE "payment_method" = 'shopify' AND "status" <> 'canceled';--> statement-breakpoint
DO $$ BEGIN

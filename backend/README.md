...
| `RESEND_REPLY_TO` | *Optional.* Reply-To header, and the address printed in the footer of every email built on `emailShell` (the campaign templates carry their own). Unset → both fall back to `RESEND_FROM_EMAIL` |

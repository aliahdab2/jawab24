...
export const UpdateSettingsSchema = z.object({
    ...
    awayMessageAr: z.string().max(500).optional(),
    awayMessageEn: z.string().max(500).optional(),
    ...
    greetingMessageAr: z.string().max(500).optional(),
    greetingMessageEn: z.string().max(500).optional(),
